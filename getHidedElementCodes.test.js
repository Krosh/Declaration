...
test('simple select with action', function() {
  ...
  var filteredQuestionsWithA1 = getHidedElementCodes_1.getHidedElementCodes(
    mock,
    getValue({ q: 'a1' }),
    function() {
      return false
  ...
  var filteredQuestionsWithA2 = getHidedElementCodes_1.getHidedElementCodes(
    mock,
    getValue({ q: 'a2' }),
    function() {
      return false
  ...
  var filteredQuestionsWithoutAnswer = getHidedElementCodes_1.getHidedElementCodes(
    mock,
    getValue({}),
    function() {
      return false
