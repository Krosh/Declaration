...
exports.AddressModel = {
    ...
    validate: function (value, isTouched, short, skipRegion, onlyIfnsfl) {
        ...
        var result = {};
        var skip = __spreadArrays(exports.AddressModel.skipDefault);
        if (short) {
