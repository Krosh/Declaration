export interface Validation {
    ...
    oneOf?: string[];
    bikName?: string;
    type?: 'inn' | 'kpp' | 'oktmo' | 'year' | 'phone' | 'okved' | 'passport' | 'bik' | 'correspondent_account' | 'client_account';
}
